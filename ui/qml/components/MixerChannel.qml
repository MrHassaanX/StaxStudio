...
ColumnLayout {
    ...
    RowLayout { Layout.fillWidth: true; spacing: 8
        ...
        Slider { Layout.fillWidth: true; from: 0; to: 1; value: root.volume; onMoved: root.volumeChangedByUser(value) }
        Text { text: Math.round(root.volume * 100) + "%"; color: "#87979C"; font.pixelSize: 10; width: 30; horizontalAlignment: Text.AlignRight }
    }
    Menu { id: options; MenuItem { text: "Audio settings"; enabled: false } }
}
